  ...
  return (
    <section className="h-[calc(100vh-90px)]  bg-[#f5f5f5] p-10 md:p-12 lg:p-14 xl:p-20">
      ...
      <div className="py-4">
        ...
        <Link to='/apps'>
        <button className="bg-linear-to-br from-[#632EE3] to-[#9F62F2] px-6 lg:px-12 py-3 rounded-sm text-xl cursor-pointer font-semibold flex items-center gap-2 text-white mt-4 xl:mt-8 mx-auto">
          Go Back
        </button>
        </Link>
      </div>
