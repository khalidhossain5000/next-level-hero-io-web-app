  ...
  return (
    <section className="relative py-4 px-4 sm:px-6 lg:px-20 shadow-sm flex items-center justify-between">
      ...
      <div className="hidden lg:block">
        <button className="bg-linear-to-br from-[#632EE3] to-[#9F62F2] px-4 py-3 rounded-xs text-[16px] font-semibold flex items-center gap-2 text-white">
          <span>
            <FaGithub />
          </span>
          Contribute
      ...
      <div className="lg:hidden">
        ...
        {/* nav item for mobile menu */}
          ...
          <div className={`flex flex-col justify-between items-start gap-1 fixed top-24 ${open ? "right-5" : "-right-60"} w-56  md:h-44 h-36  bg-slate-200 rounded-xl shadow-xl p-4  duration-1500`}>
